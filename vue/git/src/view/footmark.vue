<template>
   <div class="footmark">
     	<div v-if="favoriteList==''" class="empty">
            <img src="https://pic.repaiapp.com/static/png/20180427/16/1524816266511925698.png">
            <p>您还没有浏览过任何商品哦～</p>
        </div>
    ...
    export default {
        ...
        methods: {
            shop:function(){
                ...
                api.post('user/history_lists',params,res=>{
                console.log(res);
                    if(res.status==0){
            ...
            channel:function(id){
                ...
                api.post('user/history_del',params,res=>{
                console.log(res);
                    if(res.status==0){
                        Toast.success("删除成功");
