       ...
       <van-list v-model="loading" :finished="finished" @load="onLoad" >
         <div class="content" v-if="orderlits.length!=0">
              ...
              <div class="item" v-for="item in orderlits">
                ...
                <div>
                    <div class="itemCon" @click="orderDetail(item.id)" v-for="j in item.goods" :style="(item.status==2||item.status==3)&&(item.goods.length==1||index==item.goods.length-1)?'border:0':''" >
                        ...
                        <div class="itemStatus" style="height: auto;padding: 0;">
                          ...
                          <div class="status ">
                              <p class="gray" @click.stop="Logistics(item.id,item.is_self)">查看物流</p>
                    ...
                    <div class="itemStatus" style="background-color: #fff9f9">
                        <div class="price" style="opacity: 0">应付：￥180.00</div>
                        <div class="status ">
                            <!-- <p class="gray" @click="Logistics(item.id,item.is_self)">查看物流</p> -->
                            <p class="red" @click="confim(item.id)">确认收货</p>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          list:function(){
              var _this=this;
              const params={access_token:localStorage.getItem('access_token'),page:_this.page,type:2};
