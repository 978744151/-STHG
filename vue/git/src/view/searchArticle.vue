<template>
   <div class="searchArticle">
	      ...
	      <div style="flex:1">
			...
			<form action="">
			  <input @keyup.13=show() type="search" ref="input1" placeholder="搜索文章"  autocomplete="off">
			</form>
	      </div>
	      <span style="width: 36px;text-align: right;" @click='cannel'>取消</span>
    	</div>
    	...
    	<div class="content"  v-for="item,index in orderlits" @click="articleInfo(item.id,item.type)">
...
<script>
    ...
    export default {
        ...
        methods: {
            cannel(){
            	this.$router.replace({name: 'find', query: {}})
            },
           ...
           //  onLoad() {
            ...
            show(){
        		...
        		console.log(this.$refs.input1.value);
      				const params={keyword:this.$refs.input1.value,page:0};
      				api.post('article/search',params,res=>{
      					if(res.status==0){
      	                 	if(res.data!=''){
