                  ...
                  <div>
                      <div class="itemCon" @click="orderDetail(item.id)">
                          ...
                          <div class="shopInfo">
                              ...
                              <span class="hasfh">待发货</span>
                          </div>
                      </div>
                      <div class="itemStatus bottom">
    ...
    export default {
        ...
        methods: {
         ...
         onLoad() {
          ...
          list:function(){
              var _this=this;
              const params={access_token:localStorage.getItem('access_token'),page:_this.page,type:1};
          ...
          remind:function(id){
            ...
            console.log(res);
                if(res.status==0){
                  Toast("提醒成功");
                  const params={access_token:localStorage.getItem('access_token'),page:0,type:1};
                  api.post('order/lists',params,res=>{
                  console.log(res);
                      if(res.data.lists.length==0){
                          _this.orderlits=''
